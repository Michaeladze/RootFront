...
var Switch = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "rf-switch " + (disable ? 'rf-switch--disable' : '') + " " + className, onClick: changeState },
        react_1.default.createElement("div", { className: "rf-switch__toggle " + (s ? 'on' : 'off') + " " + helpers_1.variantClass[variant] },
