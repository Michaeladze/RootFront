...
var Badge = function (_a) {
    ...
    return (React.createElement("div", { className: "rf-badge__wrapper " + className + " " + placeNearClass, ref: wrapper },
        children,
        display &&
            React.createElement("div", { className: "rf-badge " + variantClass[variant] + " " + isDot + " " + textClass, style: coordinates }, badgeContent ? !isNaN(+badgeContent) && +badgeContent > max ? max + "+" : badgeContent : null)));
};
