...
export var getDaysForMonth = function (d) {
    var date = d || new Date();
...
export var parseToFormat = function (defaultValue) {
    var inputValue = '';
...
export var getWeekDay = function (n, locale) {
    var weekDays = {
        ru: [
            'Вс',
            'Пн',
