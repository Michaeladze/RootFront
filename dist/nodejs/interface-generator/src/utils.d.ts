...
export function removeRemoveProperty(obj: any, prop_to_del: any): void;
/**
 ...
 */
export function messResolver(obj: any): void;
export function syncVersionWorkaround(version: any): any;
