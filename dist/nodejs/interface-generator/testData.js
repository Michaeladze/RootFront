    ...
    definitions: {
        ...
        AnalysisResponse: {
            ...
            properties: {
                ...
                interpretation: {
                    type: "array",
                    description: "Информация о возможных и выбранном методах интерпретации",
                ...
                params: {
                    type: "array",
                    description: "Список уникальных значений элементов нотации и их уникальные значения",
                    items: { $ref: "#/definitions/NotationElement" }
                },
                selectedAlgorithm: {
                    description: "Информация о выбранном алгоритме",
        ...
        Dashboard: {
            ...
            properties: {
                ...
                charts: {
                    type: "array",
                    description: "Объект, содержащий в себе информацию о постройке диаграммы",
        ...
        MlKeysRequest: {
            ...
            properties: {
                featuresIds: {
                    type: "array",
                    example: [1],
                    description: "ID(s) NotationElement(s), выбранные в качестве Features",
                    items: { type: "integer", format: "int64" }
                },
                targetAttributeId: {
                    type: "integer",
                    format: "int64",
                    example: 1,
                    description: "ID NotationElementUniqueValue, выбранный в качестве Target"
                },
                targetId: {
                    type: "integer",
                    format: "int64",
