...
var log = function (sType, sLogMsg, ussage) {
    if (ussage === void 0) { ussage = "usage: yarn redux --name=<filename> --components=<listItem,listItem> --path=<path>(optional) --project=<project>(optional)"; }
    switch (sType) {
        case 'error':
